...
public class BoardRestController {
	...
	// 게시글 수정하기
	@PatchMapping("/board")
	public ResponseEntity<String> modify(Board board, String user_id) {
		// 로그인한 유저와 작성자가 같으면
	...
	public ResponseEntity<?> removeOne(@PathVariable int id, String user_id) {
		if (user_id.equals(boardService.showOne(id).getUser_id())) {
